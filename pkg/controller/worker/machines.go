...
func (w *workerDelegate) DeployMachineClasses(ctx context.Context) error {
	...
	return w.seedChartApplier.Apply(ctx, filepath.Join(aws.InternalChartsPath, "machineclass"), w.worker.Namespace, "machineclass", kubernetes.Values(map[string]interface{}{"machineClasses": w.machineClasses}), nil)
}
