	...
	Context("workerDelegate", func() {
		...
		Describe("#GenerateMachineDeployments, #DeployMachineClasses", func() {
			...
			BeforeEach(func() {
				...
				additionalHashData := []string{strconv.FormatBool(volumeEncrypted), fmt.Sprintf("%dGi", dataVolume1Size), dataVolume1Type, strconv.FormatBool(dataVolume1Encrypted), fmt.Sprintf("%dGi", dataVolume2Size), dataVolume2Type, strconv.FormatBool(dataVolume2Encrypted)}
