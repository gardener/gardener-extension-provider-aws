...
func (c *FlowContext) ensureManagedVpc(ctx context.Context) error {
	...
	desired := &awsclient.VPC{
		...
		AssignGeneratedIPv6CidrBlock: ((c.config.DualStack != nil && c.config.DualStack.Enabled) || isIPv6(c.getIpFamilies())) && c.config.Networks.VPC.Ipv6IpamPoolID == nil,
		Ipv6IpamPoolId:               c.config.Networks.VPC.Ipv6IpamPoolID,
