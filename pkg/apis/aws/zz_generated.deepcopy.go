...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ElasticFileSystem) DeepCopyInto(out *ElasticFileSystem) {
	*out = *in
	if in.ID != nil {
		in, out := &in.ID, &out.ID
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ElasticFileSystem.
func (in *ElasticFileSystem) DeepCopy() *ElasticFileSystem {
	if in == nil {
		return nil
	}
	out := new(ElasticFileSystem)
	in.DeepCopyInto(out)
	return out
}
