...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*InstanceMetadata)(nil), (*aws.InstanceMetadata)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_InstanceMetadata_To_aws_InstanceMetadata(a.(*InstanceMetadata), b.(*aws.InstanceMetadata), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*aws.InstanceMetadata)(nil), (*InstanceMetadata)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_aws_InstanceMetadata_To_v1alpha1_InstanceMetadata(a.(*aws.InstanceMetadata), b.(*InstanceMetadata), scope)
	}); err != nil {
		return err
	}
...
// Convert_v1alpha1_InstanceMetadata_To_aws_InstanceMetadata is an autogenerated conversion function.
func Convert_v1alpha1_InstanceMetadata_To_aws_InstanceMetadata(in *InstanceMetadata, out *aws.InstanceMetadata, s conversion.Scope) error {
	return autoConvert_v1alpha1_InstanceMetadata_To_aws_InstanceMetadata(in, out, s)
}
...
// Convert_aws_InstanceMetadata_To_v1alpha1_InstanceMetadata is an autogenerated conversion function.
func Convert_aws_InstanceMetadata_To_v1alpha1_InstanceMetadata(in *aws.InstanceMetadata, out *InstanceMetadata, s conversion.Scope) error {
	return autoConvert_aws_InstanceMetadata_To_v1alpha1_InstanceMetadata(in, out, s)
}
...
func autoConvert_v1alpha1_WorkerConfig_To_aws_WorkerConfig(in *WorkerConfig, out *aws.WorkerConfig, s conversion.Scope) error {
	...
	out.InstanceMetadata = (*aws.InstanceMetadata)(unsafe.Pointer(in.InstanceMetadata))
	return nil
}
...
func autoConvert_aws_WorkerConfig_To_v1alpha1_WorkerConfig(in *aws.WorkerConfig, out *WorkerConfig, s conversion.Scope) error {
	...
	out.InstanceMetadata = (*InstanceMetadata)(unsafe.Pointer(in.InstanceMetadata))
	return nil
}
