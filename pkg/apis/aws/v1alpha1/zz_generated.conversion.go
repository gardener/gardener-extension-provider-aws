...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*CapabilitySet)(nil), (*aws.CapabilitySet)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_CapabilitySet_To_aws_CapabilitySet(a.(*CapabilitySet), b.(*aws.CapabilitySet), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*aws.CapabilitySet)(nil), (*CapabilitySet)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_aws_CapabilitySet_To_v1alpha1_CapabilitySet(a.(*aws.CapabilitySet), b.(*CapabilitySet), scope)
	}); err != nil {
		return err
	}
...
// Convert_v1alpha1_CapabilitySet_To_aws_CapabilitySet is an autogenerated conversion function.
func Convert_v1alpha1_CapabilitySet_To_aws_CapabilitySet(in *CapabilitySet, out *aws.CapabilitySet, s conversion.Scope) error {
	return autoConvert_v1alpha1_CapabilitySet_To_aws_CapabilitySet(in, out, s)
}

func autoConvert_aws_CapabilitySet_To_v1alpha1_CapabilitySet(in *aws.CapabilitySet, out *CapabilitySet, s conversion.Scope) error {
	out.Regions = *(*[]RegionAMIMapping)(unsafe.Pointer(&in.Regions))
	out.Capabilities = *(*v1beta1.Capabilities)(unsafe.Pointer(&in.Capabilities))
	return nil
}

// Convert_aws_CapabilitySet_To_v1alpha1_CapabilitySet is an autogenerated conversion function.
func Convert_aws_CapabilitySet_To_v1alpha1_CapabilitySet(in *aws.CapabilitySet, out *CapabilitySet, s conversion.Scope) error {
	return autoConvert_aws_CapabilitySet_To_v1alpha1_CapabilitySet(in, out, s)
}
...
func autoConvert_v1alpha1_MachineImageVersion_To_aws_MachineImageVersion(in *MachineImageVersion, out *aws.MachineImageVersion, s conversion.Scope) error {
	out.Version = in.Version
	out.Regions = *(*[]aws.RegionAMIMapping)(unsafe.Pointer(&in.Regions))
	out.CapabilitySets = *(*[]aws.CapabilitySet)(unsafe.Pointer(&in.CapabilitySets))
	return nil
}
