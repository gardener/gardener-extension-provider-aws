...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*CSI)(nil), (*aws.CSI)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_CSI_To_aws_CSI(a.(*CSI), b.(*aws.CSI), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*aws.CSI)(nil), (*CSI)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_aws_CSI_To_v1alpha1_CSI(a.(*aws.CSI), b.(*CSI), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*ElasticFileSystem)(nil), (*aws.ElasticFileSystem)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ElasticFileSystem_To_aws_ElasticFileSystem(a.(*ElasticFileSystem), b.(*aws.ElasticFileSystem), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*aws.ElasticFileSystem)(nil), (*ElasticFileSystem)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_aws_ElasticFileSystem_To_v1alpha1_ElasticFileSystem(a.(*aws.ElasticFileSystem), b.(*ElasticFileSystem), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_CSI_To_aws_CSI(in *CSI, out *aws.CSI, s conversion.Scope) error {
	out.EfsID = in.EfsID
	return nil
}

// Convert_v1alpha1_CSI_To_aws_CSI is an autogenerated conversion function.
func Convert_v1alpha1_CSI_To_aws_CSI(in *CSI, out *aws.CSI, s conversion.Scope) error {
	return autoConvert_v1alpha1_CSI_To_aws_CSI(in, out, s)
}

func autoConvert_aws_CSI_To_v1alpha1_CSI(in *aws.CSI, out *CSI, s conversion.Scope) error {
	out.EfsID = in.EfsID
	return nil
}

// Convert_aws_CSI_To_v1alpha1_CSI is an autogenerated conversion function.
func Convert_aws_CSI_To_v1alpha1_CSI(in *aws.CSI, out *CSI, s conversion.Scope) error {
	return autoConvert_aws_CSI_To_v1alpha1_CSI(in, out, s)
}
...
func autoConvert_v1alpha1_ElasticFileSystem_To_aws_ElasticFileSystem(in *ElasticFileSystem, out *aws.ElasticFileSystem, s conversion.Scope) error {
	out.Enabled = in.Enabled
	out.ID = (*string)(unsafe.Pointer(in.ID))
	return nil
}

// Convert_v1alpha1_ElasticFileSystem_To_aws_ElasticFileSystem is an autogenerated conversion function.
func Convert_v1alpha1_ElasticFileSystem_To_aws_ElasticFileSystem(in *ElasticFileSystem, out *aws.ElasticFileSystem, s conversion.Scope) error {
	return autoConvert_v1alpha1_ElasticFileSystem_To_aws_ElasticFileSystem(in, out, s)
}

func autoConvert_aws_ElasticFileSystem_To_v1alpha1_ElasticFileSystem(in *aws.ElasticFileSystem, out *ElasticFileSystem, s conversion.Scope) error {
	out.Enabled = in.Enabled
	out.ID = (*string)(unsafe.Pointer(in.ID))
	return nil
}

// Convert_aws_ElasticFileSystem_To_v1alpha1_ElasticFileSystem is an autogenerated conversion function.
func Convert_aws_ElasticFileSystem_To_v1alpha1_ElasticFileSystem(in *aws.ElasticFileSystem, out *ElasticFileSystem, s conversion.Scope) error {
	return autoConvert_aws_ElasticFileSystem_To_v1alpha1_ElasticFileSystem(in, out, s)
}
...
func autoConvert_v1alpha1_InfrastructureConfig_To_aws_InfrastructureConfig(in *InfrastructureConfig, out *aws.InfrastructureConfig, s conversion.Scope) error {
	...
	out.ElasticFileSystem = (*aws.ElasticFileSystem)(unsafe.Pointer(in.ElasticFileSystem))
	return nil
}
...
func autoConvert_aws_InfrastructureConfig_To_v1alpha1_InfrastructureConfig(in *aws.InfrastructureConfig, out *InfrastructureConfig, s conversion.Scope) error {
	...
	out.EnableDedicatedTenancyForVPC = (*bool)(unsafe.Pointer(in.EnableDedicatedTenancyForVPC))
	out.ElasticFileSystem = (*ElasticFileSystem)(unsafe.Pointer(in.ElasticFileSystem))
	return nil
}
...
func autoConvert_v1alpha1_InfrastructureStatus_To_aws_InfrastructureStatus(in *InfrastructureStatus, out *aws.InfrastructureStatus, s conversion.Scope) error {
	...
	if err := Convert_v1alpha1_CSI_To_aws_CSI(&in.CSI, &out.CSI, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_aws_InfrastructureStatus_To_v1alpha1_InfrastructureStatus(in *aws.InfrastructureStatus, out *InfrastructureStatus, s conversion.Scope) error {
	...
	if err := Convert_aws_CSI_To_v1alpha1_CSI(&in.CSI, &out.CSI, s); err != nil {
		return err
	}
	return nil
}
