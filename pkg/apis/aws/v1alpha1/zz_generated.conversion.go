...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*AWSLoadBalancerControllerConfig)(nil), (*aws.AWSLoadBalancerControllerConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_AWSLoadBalancerControllerConfig_To_aws_AWSLoadBalancerControllerConfig(a.(*AWSLoadBalancerControllerConfig), b.(*aws.AWSLoadBalancerControllerConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*aws.AWSLoadBalancerControllerConfig)(nil), (*AWSLoadBalancerControllerConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_aws_AWSLoadBalancerControllerConfig_To_v1alpha1_AWSLoadBalancerControllerConfig(a.(*aws.AWSLoadBalancerControllerConfig), b.(*AWSLoadBalancerControllerConfig), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*IngressClass)(nil), (*aws.IngressClass)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_IngressClass_To_aws_IngressClass(a.(*IngressClass), b.(*aws.IngressClass), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*aws.IngressClass)(nil), (*IngressClass)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_aws_IngressClass_To_v1alpha1_IngressClass(a.(*aws.IngressClass), b.(*IngressClass), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_AWSLoadBalancerControllerConfig_To_aws_AWSLoadBalancerControllerConfig(in *AWSLoadBalancerControllerConfig, out *aws.AWSLoadBalancerControllerConfig, s conversion.Scope) error {
	out.Enabled = in.Enabled
	out.IngressClass = (*aws.IngressClass)(unsafe.Pointer(in.IngressClass))
	return nil
}

// Convert_v1alpha1_AWSLoadBalancerControllerConfig_To_aws_AWSLoadBalancerControllerConfig is an autogenerated conversion function.
func Convert_v1alpha1_AWSLoadBalancerControllerConfig_To_aws_AWSLoadBalancerControllerConfig(in *AWSLoadBalancerControllerConfig, out *aws.AWSLoadBalancerControllerConfig, s conversion.Scope) error {
	return autoConvert_v1alpha1_AWSLoadBalancerControllerConfig_To_aws_AWSLoadBalancerControllerConfig(in, out, s)
}

func autoConvert_aws_AWSLoadBalancerControllerConfig_To_v1alpha1_AWSLoadBalancerControllerConfig(in *aws.AWSLoadBalancerControllerConfig, out *AWSLoadBalancerControllerConfig, s conversion.Scope) error {
	out.Enabled = in.Enabled
	out.IngressClass = (*IngressClass)(unsafe.Pointer(in.IngressClass))
	return nil
}

// Convert_aws_AWSLoadBalancerControllerConfig_To_v1alpha1_AWSLoadBalancerControllerConfig is an autogenerated conversion function.
func Convert_aws_AWSLoadBalancerControllerConfig_To_v1alpha1_AWSLoadBalancerControllerConfig(in *aws.AWSLoadBalancerControllerConfig, out *AWSLoadBalancerControllerConfig, s conversion.Scope) error {
	return autoConvert_aws_AWSLoadBalancerControllerConfig_To_v1alpha1_AWSLoadBalancerControllerConfig(in, out, s)
}
...
func autoConvert_v1alpha1_ControlPlaneConfig_To_aws_ControlPlaneConfig(in *ControlPlaneConfig, out *aws.ControlPlaneConfig, s conversion.Scope) error {
	...
	out.AWSLoadBalancerController = (*aws.AWSLoadBalancerControllerConfig)(unsafe.Pointer(in.AWSLoadBalancerController))
...
func autoConvert_aws_ControlPlaneConfig_To_v1alpha1_ControlPlaneConfig(in *aws.ControlPlaneConfig, out *ControlPlaneConfig, s conversion.Scope) error {
	...
	out.AWSLoadBalancerController = (*AWSLoadBalancerControllerConfig)(unsafe.Pointer(in.AWSLoadBalancerController))
...
func autoConvert_v1alpha1_IngressClass_To_aws_IngressClass(in *IngressClass, out *aws.IngressClass, s conversion.Scope) error {
	out.Disabled = in.Disabled
	out.IsDefault = in.IsDefault
	out.IngressClassParamsSpec = (*runtime.RawExtension)(unsafe.Pointer(in.IngressClassParamsSpec))
	return nil
}

// Convert_v1alpha1_IngressClass_To_aws_IngressClass is an autogenerated conversion function.
func Convert_v1alpha1_IngressClass_To_aws_IngressClass(in *IngressClass, out *aws.IngressClass, s conversion.Scope) error {
	return autoConvert_v1alpha1_IngressClass_To_aws_IngressClass(in, out, s)
}

func autoConvert_aws_IngressClass_To_v1alpha1_IngressClass(in *aws.IngressClass, out *IngressClass, s conversion.Scope) error {
	out.Disabled = in.Disabled
	out.IsDefault = in.IsDefault
	out.IngressClassParamsSpec = (*runtime.RawExtension)(unsafe.Pointer(in.IngressClassParamsSpec))
	return nil
...
// Convert_aws_IngressClass_To_v1alpha1_IngressClass is an autogenerated conversion function.
func Convert_aws_IngressClass_To_v1alpha1_IngressClass(in *aws.IngressClass, out *IngressClass, s conversion.Scope) error {
	return autoConvert_aws_IngressClass_To_v1alpha1_IngressClass(in, out, s)
}
