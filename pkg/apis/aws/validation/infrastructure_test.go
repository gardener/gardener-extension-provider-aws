	...
	Describe("#ValidateInfrastructureConfig", func() {
		Context("Zones", func() {
			It("should forbid empty zones", func() {
				...
				errorList := ValidateInfrastructureConfig(infrastructureConfig, nil, &nodes, &pods, &services)
			...
			It("should allow specifying valid config with podsCIDR=nil and servicesCIDR=nil", func() {
				errorList := ValidateInfrastructureConfig(infrastructureConfig, nil, &nodes, nil, nil)
				Expect(errorList).To(BeEmpty())
			})
			...
			Context("CIDR", func() {
				...
				It("should forbid Pod CIDR to overlap with VPC CIDR", func() {
					...
					errorList := ValidateInfrastructureConfig(infrastructureConfig, nil, &nodes, &podCIDR, &services)
				...
				It("should forbid Services CIDR to overlap with VPC CIDR", func() {
					...
					errorList := ValidateInfrastructureConfig(infrastructureConfig, nil, &nodes, &pods, &servicesCIDR)
				...
				It("should forbid VPC CIDRs to overlap with other VPC CIDRs", func() {
					...
					errorList := ValidateInfrastructureConfig(infrastructureConfig, nil, &overlappingCIDR, &pods, &services)
