...
var _ = Describe("CloudProfileConfig validation", func() {
	DescribeTableSubtree("#ValidateCloudProfileConfig", func(isCapabilitiesCloudProfile bool) {
		var (
			...
			//coreCapabilitiesSets   []core.CapabilitySet
		...
		BeforeEach(func() {
			...
			if isCapabilitiesCloudProfile {
				...
				//coreCapabilitiesSets = []core.CapabilitySet{{Capabilities: capabilitiesDefinition}}
				regions = nil
			} else {
		...
		Context("machine image validation", func() {
			It("should pass validation with valid config", func() {
				errorList := ValidateCloudProfileConfig(cloudProfileConfig, machineImages, capabilitiesDefinition, fldPath)
